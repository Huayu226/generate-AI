...
# 設定檔案路徑
# 1. 來源圖片 (原圖)
ORIGINAL_IMAGE_PATH = r"C:\generate AI\images\a.png"

# 2. 遮罩圖片 (來自 SAM)
MASK_IMAGE_PATH = r"C:\generate AI\images\stage2_generated_mask.png"

# 3. 大腦決策檔案 (來自 OpenAI)
DECISION_FILE = "brain_decision.json"

# 4. 最終輸出路徑
OUTPUT_PATH = r"C:\generate AI\images\stage3_final_result.png"

LORA_FOLDER = r"C:\generate AI\models\loras"

LIBRARY_FILE = "lora_library.json"

IP_ADAPTER_PATH = r"C:\generate AI\models\ip_adapter"
# [新增] 精修素材的路徑
REFERENCE_IMAGE_PATH = r"C:\generate AI\images\reference_material_cutout.png"
